...
def send_test():
	...
	UDP_IP = "127.0.0.1"
	UDP_PORT = 8125
	MESSAGE = "rh.sccp.in:1|c.rh.dialogueTracker.internalContinue:1|c.rh.dialogueDatabase.findToInternal:3|ms.rh.sccp.out:1|c.rh.toInternal:1|c.rhWorker.runOnce:6|ms"
